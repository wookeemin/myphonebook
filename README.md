...
- Step 2: Create a PRIVATE repo called phonebook_app (to learn how to use private repos)

- Step 3: Prepare developer's app for production environment

- Step 4: Prepare a cloudformation template to deploy your app on Application Load Balancer together with RDS

- Step 5: Push your application into your own, newly created PRIVATE repo on Github

- Step 6: Deploy your application on AWS Cloud using Cloudformation template to showcase your app
